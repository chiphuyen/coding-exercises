...
so you can't split (using the .split() method) and then reverse the words individually.
...
Iterate over each character in the string.
	...
	+ else:
		+ if the previous character is space/tab, make it the first character of current word.
